define([
    ...
    var schema = {
        blockContent: [
            ...
            'menu', 'nav', 'ol', 'p', 'pre', 'section', 'table', 'ul', 'big', 'svg', 'use'
        ],
        phrasingContent: [
            ...
            'span', 'strong', 'sub', 'sup', 'textarea', 'time', 'u', 'var', 'video', 'wbr', 'big', 'svg', 'use'
        ],
        blockElements: [
            ...
            'p', 'pre', 'section', 'select', 'table', 'tbody', 'td', 'tfoot', 'th', 'thead', 'tr', 'ul', 'big', 'svg', 'use'
        ],
        boolAttrs: [
        ...
        whiteSpace: [
            'audio', 'iframe', 'noscript', 'object', 'pre', 'script', 'style', 'textarea', 'video', 'big', 'svg', 'use'
        ],
        selfClosing: [
            'colgroup', 'dd', 'dt', 'li', 'option', 'p', 'td', 'tfoot', 'th', 'thead', 'tr', 'big', 'svg', 'use'
        ]
    };

    schema.flowContent = schema.blockContent.concat(schema.phrasingContent, ['style']);
    schema.nonEmpty = ['td', 'th', 'iframe', 'video', 'audio', 'object', 'script', 'i', 'em', 'span', 'big', 'svg', 'use'].concat(schema.shortEnded);
    ...
    _.extend(schema, (function (phrasingContent, flowContent) {
        ...
        globalAttrs = [
            ...
            'onmousedown', 'onmouseover', 'onmousemove', 'contenteditable', 'aria-hidden'
        ];
        ...
        ['a', 'dfn', 'form', 'meter', 'progress', 'svg', 'use'].forEach(function (nodeName) {

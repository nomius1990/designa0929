...
class Banner extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $elements['image'] = $fieldset->addField(
            ...
            'image',
            [
                'title' => __('PC Banner Image'),
                'label' => __('PC Banner Image'),
                'name' => 'image',
        ...
        $elements['image'] = $fieldset->addField(
            ...
            'image',
            [
                'title' => __('Pad Banner Image'),
                'label' => __('Pad Banner Image'),
                'name' => 'image_paid',
                'note' => 'Allow image type: jpg, jpeg, gif, png',
            ]
        );
        ...
        $elements['text_color'] = $fieldset->addField(
            'text_color',
            'text',
            [
                'title' => __('Banner Text Color'),

...
class SliderItem extends \Magento\Framework\View\Element\Template
{
    ...
    public function getBannerCollection()
    {
        ...
        return $this->_bannerCollectionFactory->create()->getBannerCollection($sliderId);
    }
    ...
    public function getBannerImagePadUrl(\Magestore\Bannerslider\Model\Banner $banner)
    {
        if ($banner->getImagePaid()) {
            return $this->_bannersliderHelper->getBaseUrlMedia($banner->getImagePaid());
        }
    }

    public function getBannerImageMobileUrl(\Magestore\Bannerslider\Model\Banner $banner)
    {
        if ($banner->getImageMobile()) {
            return $this->_bannersliderHelper->getBaseUrlMedia($banner->getImageMobile());
        }
    }
    ...
    {
        return 'flexslider-'.$this->getSlider()->getId().$this->_stdlibDateTime->gmtTimestamp();
    }
}
